...
void fsync_init(void)
{
    ...
    if (st.st_ino != (unsigned long)st.st_ino)
        sprintf( shm_name, "/data/data/com.winlator/files/rootfs/tmp/wine-%lx%08lx-fsync", (unsigned long)((unsigned long long)st.st_ino >> 32), (unsigned long)st.st_ino );
    else
        sprintf( shm_name, "/data/data/com.winlator/files/rootfs/tmp/wine-%lx-fsync", (unsigned long)st.st_ino );
