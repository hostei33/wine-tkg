...
{
    static const char *nls_dirs[] = { NULL, DATADIR "/wine/nls", "/data/data/com.winlator/files/imagefs/usr/local/share/wine/nls", "/data/data/com.winlator/files/imagefs/usr/share/wine/nls" };
